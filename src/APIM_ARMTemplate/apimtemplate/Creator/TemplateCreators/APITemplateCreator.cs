...
namespace Microsoft.Azure.Management.ApiManagement.ArmTemplates.Create
{
    public class APITemplateCreator : TemplateCreator
    {
        ...
        public List<TemplateResource> CreateChildResourceTemplates(APIConfig api)
        {
            ...
            ReleaseTemplateResource releaseTemplateResource = api.isCurrent == true && api.apiRevision!= null ? this.releaseTemplateCreator.CreateAPIReleaseTemplateResource(api, dependsOn) : null;
