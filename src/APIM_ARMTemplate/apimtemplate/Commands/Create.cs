            ...
            this.OnExecute(async () =>
            {
                ...
                if (isValidCreatorConfig == true)
                {
                    ...
                    foreach (Template apiTemplate in apiTemplates)
                    {
                        ...
                        string apiFileName = fileNameGenerator.GenerateCreatorAPIFileName(providedAPIConfiguration.name, apiTemplateCreator.isSplitAPI(providedAPIConfiguration), providedAPIConfiguration.apiRevision == null);
